...
export async function sendAndWaitNoTimeout(session, options, entry, timeoutMs = DEFAULTS.sendTimeoutMs) {
  let resolveIdle;
  let rejectWithError;
  ...
  const refreshSendTimeout = (reason = 'activity') => {
    ...
    sendTimeoutId = setTimeout(() => {
      ...
      const error = Object.assign(
        ...
        { code: 'SEND_TIMEOUT', phase, timeoutMs, lastTimeoutResetReason },
      );
